...
var WorkerComponent = /** @class */ (function () {
    ...
    WorkerComponent.prototype.addWorker1 = function () {
        this.http.post('http://localhost:8080/worker/add', this.worker1, httpOptions).subscribe();
    };
    WorkerComponent.prototype.addWorker2 = function () {
        this.http.post('http://localhost:8080/worker/add', this.worker2, httpOptions).subscribe();
    };
    WorkerComponent.prototype.getWorkers = function () {
        var _this = this;
        this.http.get("http://localhost:8080/worker/list").subscribe(function (data) { return _this.workers = data; });
    };
